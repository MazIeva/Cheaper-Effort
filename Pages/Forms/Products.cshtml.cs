    ...
    public class ProductsModel : PageModel
    {
        ...
        public void OnGet()
        {
            List<Product> ProductList = new List<Product>() {
                ...
                new Product { ProductID = 6, ProductName = "Cheese" },
                new Product { ProductID = 7, ProductName = "Curry" },
                new Product { ProductID = 8, ProductName = "Mayo" },
                new Product { ProductID = 9, ProductName = "Potato" },
                new Product { ProductID = 10, ProductName = "Egg" },
                new Product { ProductID = 11, ProductName = "Flour" },
                new Product { ProductID = 12, ProductName = "Salt"}
            };
